                      ...
                      {hasChildren ? (
                        <>
                          <button
                            ...
                            className={`w-full mx-0 flex items-center justify-between rounded-none px-4 py-2.5 text-sm font-bold transition-all ${
                              isExpanded ? 'bg-slate-50 text-[#0F766E]' : 'text-slate-600 hover:bg-slate-50'
                            }`}
                          >
                            ...
                            <div className="mt-1 space-y-0.5 border-l-2 border-slate-100 ml-6 pl-2">
                              {item.children.map((child) => (
                                <NavLink
                                  ...
                                  onClick={onMobileClose}
                                  className={({ isActive }) =>
                                    `flex items-center px-4 py-2 text-[11px] font-bold uppercase tracking-wider transition-all ${
                                      isActive
                                        ? 'text-[#0F766E]'
                        ...
                        <NavLink
                          ...
                          className={({ isActive }) =>
                            `flex items-center gap-3 rounded-none px-4 py-2.5 text-sm font-bold transition-all ${isActive
                        ...
                        >
                          {({ isActive }) => (
                            <>
                              {Icon && (
                                <Icon
                                  className={`h-5 w-5 shrink-0 ${isActive ? 'text-white' : 'text-slate-400 group-hover:text-[#0F766E]'}`}
                                  aria-hidden
                                />
                              )}
                              <span>{item.label}</span>
