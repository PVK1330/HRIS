...
const adminNavGroups = [
  ...
  },
  {
    ...
    items: [
      { label: 'Departments', icon: HiBuildingOffice, path: '/admin/departments' },
      { label: 'Projects', icon: HiFolder, path: '/admin/projects' },
      { label: 'Tasks', icon: HiFlag, path: '/admin/tasks' },
      { label: 'Template Generator', icon: HiDocumentText, path: '/admin/templates' },
    ],
  },
  {
