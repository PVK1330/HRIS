...
export default function TerminationTypes() {
    ...
    <div className="space-y-6 animate-in fade-in duration-500 min-w-0">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between min-w-0">
        <div className="min-w-0">
          <h1 className="font-display text-2xl font-bold tracking-tight text-slate-900 truncate">Termination Types</h1>
          <div className="mt-1 flex items-center gap-1.5 text-xs font-medium text-slate-500 truncate">
            <span>Settings</span>
            <span className="text-slate-400">&gt;</span>
            <span className="text-slate-600">Termination Types</span>
          </div>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          >
            <HiPlus className="h-4 w-4" /> Add Type
          </button>
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-none border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-[#0F766E] bg-[#0F766E] px-5 py-3">
          <h2 className="text-sm font-semibold text-white">Termination Types Listing</h2>
        </div>
